...
// 		? {
// 				[Table in keyof Tables]: Tables[Table] extends { Row: infer Row }
// 					? Row
// 					: unknown;
// 			}
// 		: {};
...
// 	 */
// 	static fromSupabaseTypes<T extends SupabaseDatabase>(): DatabaseSchema<
// 		ConvertSupabaseTables<T>
// 	> {
// 		return new DatabaseSchema();
// 	}
// }
...
// export type InferEventsFromSchema<T> = T extends EventSchemas<
// 	infer TSchema,
// 	infer TUnion
// >
// 	? readonly [...TSchema, TUnion]
